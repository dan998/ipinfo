...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mAuthor \033[01;37m:- \033[01;36mDan Maffia 
         \033[01;33mPowered By \033[01;37m:- \033[01;36mAex Software's

 \033[01;33mipinfo\033[01;32m is use \033[01;36mip-api \033[01;32mto retrive any ip address information. Our system will automatically ban any IP addresses doing over 150 requests per minute.\033[00m


EOL;
  $getact = readline('  ipinfo >> ');
  menu();
}

function upd() {
  logo();
  echo "\n\033[01;32mUpdating ipinfo.........\033[01;37m\n\n";
  sleep(1);
  system("cd ~/ && git clone https://github.com/rajkumardusad/ipinfo.git");
  system("cd ~/ && sudo git clone https://github.com/dan998/ipinfo.git");
  system("cd ~/ipinfo && sh install");
  logo();
  echo "\n\033[01;32m              ipinfo updated !!!\033[01;37m\n";
  sleep(1);
  menu();
}
...
function menu() {
  ...
  echo "   \033[01;32m[ \033[01;37m5 \033[01;32m] \033[01;33mUpdate ipinfo.\n";
  echo "   \033[01;32m[ \033[01;37mx \033[01;32m] \033[01;33mExit \n\n\033[00m";
  $inp = readline('  36mipinfo >> ');
  if ($inp=="x" || $inp=="exit") {
    echo "\n\033[01;31m  Exiting .......\033[00m\n";
    sleep(1);
    echo "\033[01;32m  Bye love....... :)\n\n\033[00m";
    exit();
  } else if ($inp=="1") {
    trac();
  } else if ($inp=="2") {
