#ip tracker v0.5 provider by Coding Family
#Creator Dan Maffia
#python script
#Follw Me
...
print   
print	"\033[1;32mCreator			:Dan Maffia\033[1;32m"
print	"\033[1;32Github			:https://github.com/dan998\033[1;32m"
...
print	"\033[1;32mcoded by		:Coding Family\033[1;32m"
print
print"\033[1;33m==================================================================================================\033[1;33m"
...
while True:
    ...
    if ip == 'exit':
        ...
        if result1['status'] == 'success':
            ...
            print ("\n\033[1;33mAll Your Information Of IP Is Here \033[1;33m[" + ip + "] :\n")
	    ...
	    print ("Then search the Google Map using the Latitude or longitude number")
            ...
            print ("\n\033[1;31mSorry, Please Enter The IP[" + ip + "] Please try again\033[1;31m\n")
